...
const fiveOutPlays: CourtPlay[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        positions: [
          { x: 50, y: 8, label: '1' },
          { x: 20, y: 35, label: '2', hasBall: true },
          { x: 80, y: 35, label: '3' },
          { x: 15, y: 65, label: '4' },
          { x: 85, y: 65, label: '5' },
        ],
  ...
  },
  {
    ...
    steps: [
      ...
      {
        positions: [
          { x: 50, y: 25, label: '1', hasBall: true },
          { x: 20, y: 35, label: '2' },
          { x: 80, y: 35, label: '3' },
          { x: 15, y: 65, label: '4' },
          { x: 85, y: 65, label: '5' },
      ...
      },
      {
        positions: [
          { x: 50, y: 25, label: '1' },
          { x: 20, y: 35, label: '2' },
          { x: 80, y: 25, label: '3', hasBall: true },
          { x: 15, y: 65, label: '4' },
          { x: 85, y: 65, label: '5' },
        ],
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        movements: [
          { from: 0, to: 0, type: 'screen', path: [{ x: 65, y: 20 }] },
        ],
      },
      {
        positions: [
        ...
        movements: [
          { from: 2, to: 2, type: 'cut', path: [{ x: 75, y: 25 }] },
        ],
      },
      {
        positions: [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        positions: [
          { x: 50, y: 8, label: '1' },
          { x: 35, y: 20, label: '2', hasBall: true },
          { x: 80, y: 35, label: '3' },
          { x: 15, y: 65, label: '4' },
          { x: 85, y: 65, label: '5' },
        ],
      ...
      },
      {
        positions: [
          { x: 45, y: 12, label: '1' },
          { x: 42, y: 15, label: '2', hasBall: true },
          { x: 80, y: 35, label: '3' },
          { x: 15, y: 65, label: '4' },
          { x: 85, y: 65, label: '5' },
        ],
