    ...
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 safe-area-bottom shadow-lg">
        <div className="flex justify-around items-center max-w-screen-lg mx-auto">
          <Link
            to="/"
            className={`nav-link flex-1 ${isActive('/') ? 'nav-link-active' : ''}`}
          >
          ...
          <Link
            to="/players"
            className={`nav-link flex-1 ${isActive('/players') ? 'nav-link-active' : ''}`}
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link
            to="/schedule"
            className={`nav-link flex-1 ${isActive('/schedule') ? 'nav-link-active' : ''}`}
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link
            to="/training"
            className={`nav-link flex-1 ${isActive('/training') ? 'nav-link-active' : ''}`}
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link
            to="/stats"
            className={`nav-link flex-1 ${isActive('/stats') ? 'nav-link-active' : ''}`}
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
